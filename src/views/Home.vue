    ...
    methods: {
      ...
      getOptions(orgInfo) {
        ...
        function getMuleleJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=Mulele');
        }
        function getCropPeriodJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=CropPeriod');
        }
        function getCgsuitableJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=Cgsuitable');
        }
        function getFasuitableJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=Fasuitable');
        }
        function getAmdisasterJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=Amdisaster');
        }

        function getSoilmoistureJson() {
          return axios.get(baseUrl + 'qhzxsp/getAgroImageVoByType.do?orgcode=' + orgInfo.code + '&type=Soilmoisture');
        }
