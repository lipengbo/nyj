<template>
  <div style="width:100%">
    <div class="m-stat-header">
      <div class="u-bar u-white f-bb1 ">
        ...
        <ul>
          ...
          <li v-for="item in stationtypeData" :key="item.text" :class="item.value==selectedStationType?'f-active':''" :data-value="item.value" @click="changeStationType">
            {{item.text}}
          </li>
    ...
    <ul class="m-list-img" v-if="voImages">
      <li v-for="item in voImages" :key="item.url">
    ...
    <el-dialog title="广东省农业气象综合平台--绘图" :visible.sync="isLayerShow" width="90%" :close-on-click-modal="true" top="25px">
