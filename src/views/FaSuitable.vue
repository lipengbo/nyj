                ...
                methods: {
                        getOptions() {
                                var axios = this.$axios,
                                        _this = this;
                                this.$axios.get(baseUrl + "/getAgrForecastEleVoListByType.do?type=Fasuitable").then(res => {
                                        _this.eles = res.data;
                        ...
                        getAgrForecastInfoStatisticsVoByQueryVo() {
                                ...
                                var url = baseUrl + "/getAgrForecastInfoStatisticsVoByQueryVo.do?queryVo.eletype=" + _this.selectedEle + "&queryVo.enddate=" + _this.eDate +
                                        ...
                                        _this.selectedStationType + "&queryVo.type=Fasuitable";
                                var tableList = [],
                                        tableColumns = [{
                                                value: "stacode",
                                                text: "站点"
