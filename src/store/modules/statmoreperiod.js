...
export default {
    ...
    namespace: 'statmoreperiod/',
    state: {
        eles: null,
        datetypes: [{ value: 0, text: "阳历" }, { value: 1, text: "农历" }],
        selectedDataType: 0,
        ...
        selectedCqType: "ele",
        pertypes: [{ value: "per", text: "常年" }, { value: "year", text: "某年" }],
        selectedPerType: "per",
        years: years,
        statype: "1", //默认国家站
    ...
    actions: {
        ...
        changeOptions({ dispatch, commit, state }, params) {
            ...
            var climateStatisticsVo = require("../../../static/01/ClimateStatisticsVo.json");
            params.climateStatisticsVo = climateStatisticsVo;
